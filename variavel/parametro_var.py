        ...
        if(len(self.token)>0):  
            match self.list[0]:
                ...
                case '=':
                    ...
                    self.list.pop(0)
                    self.token.pop(0)
                    iniciar_automato = variavel.valor_variavel.valor_variavel(self.list,self.n, self.erro,self.token)
                    iniciar_automato.E0()
                case '[':
                    self.n.pop(0)
                    self.list.pop(0)
                    self.token.pop(0)
                    iniciar_automato = variavel.parametro_vetor.parametro_vetor(self.list, self.n, self.erro, self.token)
                    iniciar_automato.E0()
                case _:
