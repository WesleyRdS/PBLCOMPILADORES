...
class printar:
        ...
        if len(self.list) > 0:
            if self.list[0] == "(":
                ...
                if len(self.list) > 0:
                    if self.list[0] == ")":
                        self.E2()
                    elif self.token[0] == "CAC" or self.list[0] == "true" or self.list == "false" or self.token[0] == "NRO":
                        self.list.pop(0)
                        self.token.pop(0)
                        self.n.pop(0)
                        self.E2()
                    elif self.token[0] == "IDE":
                        self.remetente.insert(0,"print")
    ...
    def E3(self):
        ...
        print(self.token)
        if len(self.list) > 0:
            if self.token[0] == "CAC" or self.list[0] == "true" or self.list == "false"  or self.token[0] == "NRO":
                self.list.pop(0)
                self.token.pop(0)
                self.n.pop(0)
                self.E4()
