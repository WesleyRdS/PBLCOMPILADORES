        ...
        if len(self.list) > 0:
            if self.list[0] == "(":
                ...
                if len(self.list) > 0:
                    if self.list[0] == ")":
                        self.E2()
                    elif self.token[0] == "CAC" or self.list[0] == "true" or self.list == "false":
                        self.list.pop(0)
                        self.token.pop(0)
                        self.n.pop(0)
                        self.E2()
                    elif self.token[0] == "IDE" or self.token[0] == "NRO":
                        iniciar_automato = atribuir_valor.atribuir_valor(self.list,self.n, self.erro,self.token,"print")
                        iniciar_automato.E0()
                    else:
